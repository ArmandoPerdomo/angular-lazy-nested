...
@Injectable()
export class PdfDevolucionDigitalService extends ExportService {

  constructor() {
    super();
  }

  public pdfDevolucion(dr: RepAdmFormatosOut) {
    var self = this;
    ...
    const docDefinition = {
      ...
      info: {
        title: 'Devolución digital - Nro. '+dr.FormatosResult.Encabezado.Numero
      },
      // ------------------------------ HEADER -------------------------------------
