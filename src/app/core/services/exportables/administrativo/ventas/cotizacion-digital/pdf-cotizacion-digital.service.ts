...
@Injectable()
export class PdfCotizacionDigitalService extends ExportService {

  constructor() {
    super();
  }
  
  public pdfCotizacion(dr: RepAdmFormatosOut) {
    var self = this;
    ...
    const docDefinition = {
      ...
      info: {
        title: 'Cotización digital - Nro. '+dr.FormatosResult.Encabezado.Numero
      },
      // ------------------------------ HEADER -------------------------------------
