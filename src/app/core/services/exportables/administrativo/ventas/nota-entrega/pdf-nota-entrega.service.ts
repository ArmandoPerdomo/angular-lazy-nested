...
@Injectable()
export class PdfNotaEntregaService extends ExportService {

  constructor() {
    super();
  }

  public pdfNotaEn(dr: RepAdmFormatosOut) {
    var self = this;
    ...
    const docDefinition = {
      ...
      info: {
        title: 'Nota de entrega digital - Nro. '+dr.FormatosResult.Encabezado.Numero
      },
      // ------------------------------ HEADER -------------------------------------
