...
@Injectable()
export class PdfCobroDigitalService extends ExportService {

  constructor() {
    super();
  }

  public pdfCobro(dc: RepAdmFormatosCobPagOut) {
    var self = this;
    const docDefinition = {
      pageSize: 'LEGAL',
      defaultStyle: {
      ...
      info: {
        title: 'Cobro digital - Nro: '+ dc.FormatosCobPagResult.Encabezado.Numero.toString()
      },
      // ------------------------------ HEADER -------------------------------------
              ...
              [
                ...
                [{
                  ...
                  table: {
                    widths: [55, 155],
                    body: [
                      ['Cobrador:', dc.FormatosCobPagResult.Encabezado.Cobrador.toString()],
                    ]
                  },
                  layout: {
                    hLineWidth: function (i, node) {
