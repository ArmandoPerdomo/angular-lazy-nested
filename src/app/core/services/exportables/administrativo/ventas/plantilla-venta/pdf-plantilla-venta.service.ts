...
@Injectable()
export class PdfPlantillaVentaService extends ExportService {

  constructor() {
    super();
  }

  public pdfPlantilla(dr: RepAdmFormatosOut) {
    var self = this;
    ...
    const docDefinition = {
      ...
      info: {
        title: 'Plantilla digital - Nro. '+dr.FormatosResult.Encabezado.Numero
      },
      // ------------------------------ HEADER -------------------------------------
