...
@Injectable()
export class PdfNotaDespachoService extends ExportService {

  constructor() {
    super();
  }

  public pdfNotaDe(dr: RepAdmFormatosOut) {
    var self = this;
    ...
    const docDefinition = {
      ...
      info: {
        title: 'Nota de despacho digital - Nro. '+dr.FormatosResult.Encabezado.Numero
      },
      // ------------------------------ HEADER -------------------------------------
          ...
          columns: [{
            ...
            },
            {
              ...
              table: {
                ...
                body:  
                [
                  [{text:'\nNro:',bold: 'true'},{text:'\n00-'  + dr.FormatosResult.Encabezado.Numero.toString(), alignment: 'right'}],
