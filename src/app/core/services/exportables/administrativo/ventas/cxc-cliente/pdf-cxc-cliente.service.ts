...
@Injectable()
export class PdfCxcClienteService extends ExportService {
  ...
  public PdfCxC(dc: any) {
    var data;
    var nro;
    var title;

    title = 'DOCUMENTO CxC';
    data = dc.RepCxCPorClienteResult.Clientes;
    nro = 'Nro_doc';
    ...
    var dd = {
      ...
      pageSize: 'LEGAL',
      pageMargins: [28, 140, 10, 20], //Content margins
      defaultStyle: {
        fontSize: 8
      }
    }
