...
@Injectable()
export class PdfOrdenCompraService extends ExportService {

  constructor() {
    super();
  }

  public pdfOrdenC(dr: RepAdmFormatosOut) {
    var self = this;
    ...
    const docDefinition = {
      ...
      info: {
        title: 'Órden de compra digital - Nro. '+dr.FormatosResult.Encabezado.Numero
      },
      // ------------------------------ HEADER -------------------------------------
            ...
            },
            {
              ...
              table: {
                ...
                body: [
                  ...
                  [{text:'Persona de contacto',bold: 'true'},{text: dr.FormatosResult.Encabezado.Vendedor.toString(), alignment: 'right'}],
                  [{text:'Email:',bold: 'true'},{text: dr.FormatosResult.Encabezado.Email.toString(), alignment: 'right'}],
