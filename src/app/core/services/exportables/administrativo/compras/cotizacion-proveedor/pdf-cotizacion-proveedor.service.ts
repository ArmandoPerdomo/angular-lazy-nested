...
@Injectable()
export class PdfCotizacionProveedorService extends ExportService {

  constructor() {
    super();
  }

  public pdfCotizacionCompra(dr: RepAdmFormatosOut) {
    var self = this;
    ...
    const docDefinition = {
      ...
      info: {
        title: 'Cotización al proveedor - Nro. '+dr.FormatosResult.Encabezado.Numero
      },
      // ------------------------------ HEADER -------------------------------------
