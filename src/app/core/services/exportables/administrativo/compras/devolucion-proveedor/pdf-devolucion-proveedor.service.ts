...
@Injectable()
export class PdfDevolucionProveedorService extends ExportService {

  constructor() {
    super();
  }

  public pdfDevolucionCompra(dr: RepAdmFormatosOut) {
    var self = this;
    ...
    const docDefinition = {
      ...
      info: {
        title: 'Devolución al proveedor - Nro. '+dr.FormatosResult.Encabezado.Numero
      },
      // ------------------------------ HEADER -------------------------------------
            ...
            },
            {
              ...
              table: {
                ...
                body: [
                  ...
                  [{text:'Nota de crédito:',bold: 'true'},{text: dr.FormatosResult.Encabezado.NumNCR.toString(), alignment: 'right'}],
                ]
              },
              layout: 'noBorders'
            }
