...
@Injectable()
export class PdfFacturaCompraService extends ExportService {

  constructor() {
    super();
  }

  public pdfFacturaCompra(dr: RepAdmFormatosOut) {
    var self = this;
    ...
    const docDefinition = {
      ...
      info: {
        title: 'Factura de compra - Nro. '+dr.FormatosResult.Encabezado.Numero
      },
      // ------------------------------ HEADER -------------------------------------
