...
@Injectable()
export class PdfGananciaPerdidaService extends ExportService {
  ...
  public pdfGanPer(dout: any[], din: any) {
    var self = this;
    var title = "";
    ...
    var dd = {
      info: 
      {
          title: 'Estado de ganancia y pérdida'
       },
  ...
  buildBody(dat, din) {
    ...
    total.push(
      {},
      {text:'TOTAL DE GANANCIAS Y PÉRDIDAS:',bold: true,alignment:'right' },
