...
@Injectable()
export class PdfBalanceGeneralService extends ExportService {
  ...
  public pdfGeneral(dout: any[], din: any) {
    var self = this;
    var dd = {
      info: 
      {
      ...
      header: function(currentPage, pageCount){/*Tabla del header*/
          ...
          [
            [//Primera fila
              ...
              [ //Segunda fila
                  {
                    text: 'DOCUMENTO DE BALANCE DE GENERAL (Orden: Código)',
                    style: 'header',
                    colSpan: 3,
                    alignment: 'center',
                    margin: [20, 0,0,0]
    ...
    styles: {
      ...
      pageSize: 'LETTER',
      pageMargins: [40, 140, 10, 20],//Content margins
      defaultStyle: {
          fontSize: 8
      }
  ...
  buildBody(dat, din) {
    ...
    dat.forEach(a => {
      ...
      if (a.children.length == 0 || a.children == [] && din.Nivel == 1)
      {
        ...
        (din.Nivel == 1)? rowFirst1.push({text:a.data.code},{text:a.data.desc},{text: this.moneyTrans(a.data.saldoActual),alignment:'right'}) :rowFirst1.push({text:a.data.code, bold:true},{text:a.data.desc, bold:true},{text: this.moneyTrans(a.data.saldoActual),alignment:'right', bold:true}) ;
        ...
        a.children.forEach(b => {
          ...
          if(din.Nivel == 2){
            ...
            rowSecond1.push({text:b.data.code},{text:b.data.desc, margin:[10,0,0,0]},{text: this.moneyTrans(b.data.saldoActual),alignment:'right'});
            ...
            b.children.forEach(c => {
              ...
              if(din.Nivel == 3){
                //! 3 NIVELES 
                  ...
                  rowThird1.push({text:c.data.code},{text:c.data.desc, margin:[20,0,0,0]},{text: this.moneyTrans(c.data.saldoActual),alignment:'right'});
    ...
    total.push(
      {},
      {text:'TOTAL DE BALANCE GENERAL:',bold: true,alignment:'right' },
